...
- **1940 tests**, 76 CLI commands, 81 MCP tools
...
| 81 MCP tools for AI agents | **Website** — landing + docs portal (PRD-024) |
...
| Done | Gap |
|---|---|
| MCP server (81 tools, stdio transport) | **Linear/Jira sync** (NOTE-028) |
