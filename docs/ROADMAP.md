...
- **1940 tests**, 76 CLI commands, 74 MCP tools
...
| 74 MCP tools for AI agents | **Website** — landing + docs portal (PRD-024) |
...
| Done | Gap |
|---|---|
| MCP server (74 tools, stdio transport) | **Linear/Jira sync** (NOTE-028) |
