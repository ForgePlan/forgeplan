...
Если все evidence получены в рамках одной сессии (один разговор, один PoC), это CL1 — ограниченная достоверность. Нужны внешние подтверждения: документация, бенчмарки других проектов, production опыт.
...
### CL penalties (штрафы за уровень достоверности)

| Confidence Level | Penalty | Описание |
|------------------|---------|----------|
| CL3 — Verified | 0.0 | Проверено независимо, production данные |
| CL2 — Tested | 0.1 | Протестировано локально, PoC |
| CL1 — Inferred | 0.4 | Выведено логически, из документации |
| CL0 — Speculative | 0.9 | Предположение, без подтверждений |
