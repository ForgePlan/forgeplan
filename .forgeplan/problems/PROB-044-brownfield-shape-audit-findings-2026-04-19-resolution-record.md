...
| H5 | EVID-079 CL2 too weak | MOSTLY RESOLVED — Spike-1 (EVID-081 CL3 c4-to-forge) + Spike-3 (EVID-082 CL3 ddd-to-forge) both pass. Cross-harness install CL3 still pending but orchestrator-model validation is now double-confirmed |
