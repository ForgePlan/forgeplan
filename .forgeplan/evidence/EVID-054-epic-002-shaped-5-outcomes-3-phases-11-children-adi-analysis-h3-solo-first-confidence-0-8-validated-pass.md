...
# EVID-054: EPIC-002 shaped: 5 outcomes, 3 phases, 11 children, ADI analysis (H3 Solo-first confidence 0.8), validated PASS
...
| Target | ADR-054 (решение которое подтверждаем/опровергаем) |
