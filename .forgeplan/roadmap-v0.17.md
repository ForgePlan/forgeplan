...
dev  ◄───────────────────────────── release/v0.17.0 (sync back)
                          ...
                          ┌───────────────┼───────────────┬──────────────┐
                          │               │               │              │
              feat/sprint-13.0    feat/prd-039    feat/prd-035-p1   feat/prd-035-p2
                  security          search-v2        tags-tier        discover-mcp
                          │               │               │              │
                          │               │               │              │
                          ▼               ▼               ▼              ▼
              ...
              ┌───────────┼───────────────┬───────────────┐
              │           │               │               │
        feat/prd-040  feat/prd-041    feat/prd-042
          scoring      fpf-rules      kb-vector
```
...
### Sprint 13.4a — Discovery Phase 1: Tags + Source Tier 🟡
...
### Sprint 13.4b — Discovery Phase 1: MCP Tools + CLI 🟡

| Field | Value |
|-------|-------|
| Branch | `feat/sprint-13.4b-prd-035-discover` |
| Depends on | Sprint 13.4a merged |
| Type | Feature (Deep) |
...
### Sprint 13.2 — RFC-001 Phase 3: FPF Rules CLI/MCP 🟡
...
| Time | 1d |
| LOC | ~150 |
| Artifact | PRD-041 (TO SHAPE) |

**Pre-sprint:** shape PRD-041 (this batch).
...
| Time | 0.5-1d |
| LOC | ~150 |
| Artifact | PRD-042 (TO SHAPE) |

**Pre-sprint:** shape PRD-042 (this batch).

**Waves:**
- W1 Implementation: `kb-vector-impl` + `embed-driver-wire`
- W2 Tests + Audit
...
После merge всех 7 sprint'ов в `release/v0.17.0`:
...
- [ ] EPIC-003 created and shaped
- [ ] PRD-041 (FPF Rules) created and shaped
- [ ] PRD-042 (KB Vector Search) created and shaped
- [ ] Both new PRDs validated PASS
- [ ] All artifacts linked to EPIC-003
- [ ] release/v0.17.0 branch created from dev
