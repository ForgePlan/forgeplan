...
- **PRD-064** (new kinds `kb/runbook/postmortem/retrospective/meeting`) — kinds из EPIC-008 (6 formal Factum/Intent kinds) более глубокие и systematic чем документационные категории PRD-064. PRD-064 deprecate при activate EPIC-008.
...
| PRD-064 supersede breaks existing workflows | Low | Low | PRD-064 never activated, never released in v0.X; safe to supersede |
...
| PRD-064 | PRD | supersedes (new kinds scope superseded by formal Factum/Intent kinds) |
| EPIC-006 | Epic | informs (brownfield documentation migration complement) |
