# Cover prompt: kak-polzovatsya-fpf (How to start using FPF - 3-step protocol)

## Slugs
- RU: `kak-polzovatsya-fpf`
- EN: `how-to-use-fpf`

## Output filename
`/website/public/blog-covers/kak-polzovatsya-fpf.webp` (1600x900, ~95-97% quality)
...
## Style refs
- Companion to `chto-takoe-fpf.webp` and `gde-rabotaet-fpf.webp` (same series, same palette)
...
1. Save PNG -> `/tmp/kak-polzovatsya-fpf-raw.png`
2. Convert: `cwebp -q 95 -m 6 /tmp/kak-polzovatsya-fpf-raw.png -o website/public/blog-covers/kak-polzovatsya-fpf.webp`
