...
ForgePlan ships 76 CLI commands and 63 MCP tools. The MCP server uses [rmcp](https://github.com/modelcontextprotocol/rust-sdk) (the official Model Context Protocol Rust SDK) so Claude Code, Cursor, or Aider can drive the methodology natively:
