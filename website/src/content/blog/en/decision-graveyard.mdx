...
This format isn't my invention; different people have called it different things. I settled on the name **DDR** (Detailed Decision Record) - a short record that drives the team toward a decision, rather than describing it after the fact.
