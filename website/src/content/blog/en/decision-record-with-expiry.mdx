...
DDR (Detailed Decision Record) - an extended ADR format that explicitly captures evidence and review conditions - is a short record that guides the team toward a decision rather than describing it after the fact. Six sections. Each one closes off a class of mistakes that otherwise surfaces a year later.
