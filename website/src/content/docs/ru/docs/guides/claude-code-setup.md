...
Это предоставляет AI агентам доступ к 73 инструментам: create, validate, score, search, graph, reason, route, плюс оркестрация playbook'ов, FPF KB, dispatch, claims, и другие.
