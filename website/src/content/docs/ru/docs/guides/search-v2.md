---
title: Интеллектуальный поиск (v0.18 BM25 + русская морфология)
description: "Как производственный BM25-движок Forgeplan находит артефакты -- стемминг, многоязычная поддержка и использование CLI/MCP."
---
...
Сверху может быть наложен опциональный семантический этап, основанный на эмбеддингах BGE-M3 — см. раздел [Семантический поиск](#семантический-поиск-флаг-функции) ниже.
