...
|---|---|---|---|
| `session_id` | `string` | да | Идентификатор сессии из `forgeplan_discover_start`. Должен быть активным. |
...
- [`forgeplan discover complete`](/docs/cli/discover-complete/) — та же финализация из терминала.

## См. также

- [Обзор MCP](/docs/mcp/)
- [`forgeplan_discover_start`](/docs/mcp/forgeplan_discover_start/) — начать сессию
- [`forgeplan_discover_finding`](/docs/mcp/forgeplan_discover_finding/) — сообщать наблюдения
- [`forgeplan_health`](/docs/mcp/forgeplan_health/) — снимок состояния, включённый в сводку
- [`forgeplan_new`](/docs/mcp/forgeplan_new/) — перенести предложение в реальный артефакт
