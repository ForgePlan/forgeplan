...
Note и Problem могут быть активированы без гейта валидации. Это сделано намеренно — Note представляют собой быстрые записи (автоматическое истечение срока через 90 дней), а Problem — это наблюдения, которые необходимо быстро зафиксировать без лишних препятствий.
