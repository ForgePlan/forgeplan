...
```text
  ...
  -s, --status <STATUS>  Фильтр по статусу (черновик, активный, замещённый, устаревший, просроченный)
      --depth <DEPTH>    Фильтр по глубине (тактическая, стандартная, глубокая, критическая)
      ...
      --since <SINCE>    Только артефакты, созданные после этой даты (ГГГГ-ММ-ДД)
