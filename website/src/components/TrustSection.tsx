 ...
 * No pin — simple scroll-driven via IntersectionObserver.
 * Rings animate based on how far user has scrolled through the section.
 */
export default function TrustSection() {
  ...
  return (
    <section id="trust" ref={sectionRef} className="relative w-full min-h-screen bg-forge-bg border-b border-forge-line">
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_500px] min-h-screen pt-[36px]">
        ...
        <div className="flex flex-col justify-between p-8 lg:p-12">
          ...
          <div className="space-y-8">
            ...
            <div style={{ opacity: textOpacity(0.55) }}>
              ...
              <p className="text-sm text-forge-dim leading-relaxed mt-1">Evidence has a TTL. Expired evidence scores 0.1 — stale, not absent. Dashed outer ring = decay zone.</p>
            </div>
            <hr className="border-forge-line" />
            <div style={{ opacity: textOpacity(0.7) }}>
              <p className="text-base font-medium">Congruence Levels</p>
              <p className="text-sm text-forge-dim leading-relaxed mt-1">Evidence from the same context scores highest. Opposing context gets penalized. Each ring represents a confidence level.</p>
            </div>
          </div>
